...
?>
<div id="<?php print $html_id; ?>" class="pgbar-wrapper clearfix pgbar-wrapper-thermometer" data-pgbar-current="<?php print $current; ?>" data-pgbar-target="<?php print $target; ?>" data-pgbar-inverted="true" data-pgbar-direction="vertical">
